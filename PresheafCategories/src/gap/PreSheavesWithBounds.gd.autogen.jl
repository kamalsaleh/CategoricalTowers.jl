...
#! @Arguments category
@DeclareFilter( "IsPreSheafWithBoundsCategory",
        IsCapCategory );

#! @Description
#!  The &GAP; category of cells in a presheaf category.
#! @Arguments cell
@DeclareFilter( "IsCellInPreSheafWithBoundsCategory",
        IsCapCategoryCell );

#! @Description
#!  The &GAP; category of objects in a presheaf category.
#! @Arguments obj
@DeclareFilter( "IsObjectInPreSheafWithBoundsCategory",
...
#! @Arguments mor
@DeclareFilter( "IsMorphismInPreSheafWithBoundsCategory",
...
@DeclareOperation( "PreSheavesWithBounds",
...
@DeclareFilterDispatchedOperation( "PreSheavesWithBounds" );
