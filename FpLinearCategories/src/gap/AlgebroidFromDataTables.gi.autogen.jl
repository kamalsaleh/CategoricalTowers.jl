                                  ...
                                  ListN( labels,
                                    function ( l )
                                      if (l[2] == 1)
                                        ...
                                        return @Concatenation( LATEX_LBRACE, l[1], LATEX_RBRACE, "^", LATEX_LBRACE, StringGAP( l[2] ), LATEX_RBRACE );
                                      end;
                                    end ), "" );
...
InstallMethodWithCache( TensorProductOfAlgebroids,
  ...
  function ( A_1, A_2 )
    ...
    if (@not IsIdenticalObj( CommutativeSemiringOfLinearCategory( A_1 ), CommutativeSemiringOfLinearCategory( A_2 ) ))
