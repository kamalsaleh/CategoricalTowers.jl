...
#! @Arguments A
@DeclareFilter( "IsFpLinearCategory", FilterIntersection( IsCapCategory, IsFinitelyPresentedLinearCategory ) );

#! @Description
#!  The filter for objects in finitely presented linear &CAP; categories.
#! @Arguments obj
@DeclareFilter( "IsObjectInFpLinearCategory", IsCapCategoryObject );

#! @Description
#!  The filter for morphisms in finitely presented linear &CAP; categories.
#! @Arguments mor
@DeclareFilter( "IsMorphismInFpLinearCategory", IsCapCategoryMorphism );

#! @Description
#!  The filter for linear closures of path categories.
#! @Arguments kC
@DeclareFilter( "IsLinearClosureOfPathCategory", FilterIntersection( IsLinearClosure, IsFpLinearCategory ) );

#! @Description
#!  The filter for objects in linear closures of path categories.
#! @Arguments obj
@DeclareFilter( "IsObjectInLinearClosureOfPathCategory", FilterIntersection( IsLinearClosureObject, IsObjectInFpLinearCategory ) );

#! @Description
#!  The filter for morphisms in linear closures of path categories.
#! @Arguments mor
@DeclareFilter( "IsMorphismInLinearClosureOfPathCategory", FilterIntersection( IsLinearClosureMorphism, IsMorphismInFpLinearCategory ) );

#! @Description
#!  The filter for linear closures of quotients of path categories.
#! @Arguments kC
@DeclareFilter( "IsLinearClosureOfQuotientOfPathCategory", FilterIntersection( IsLinearClosure, IsFpLinearCategory ) );

#! @Description
#!  The filter for objects in linear closures of quotients of path categories.
#! @Arguments obj
@DeclareFilter( "IsObjectInLinearClosureOfQuotientOfPathCategory", FilterIntersection( IsLinearClosureObject, IsObjectInFpLinearCategory ) );

#! @Description
#!  The filter for morphisms in linear closures of quotients of path categories.
#! @Arguments mor
@DeclareFilter( "IsMorphismInLinearClosureOfQuotientOfPathCategory", FilterIntersection( IsLinearClosureMorphism, IsMorphismInFpLinearCategory ) );
...
#! @Arguments kC
@DeclareFilter( "IsQuotientCategoryOfLinearClosureOfPathCategory", FilterIntersection( IsQuotientCategory, IsFpLinearCategory ) );
#! @Description
#!  The filter for objects in quotient categories of linear closures of path categories.
#! @Arguments obj
@DeclareFilter( "IsObjectInQuotientCategoryOfLinearClosureOfPathCategory", FilterIntersection( IsQuotientCategoryObject, IsObjectInFpLinearCategory ) );
#! @Description
#!  The filter for morphisms in quotient categories of linear closures of path categories.
#! @Arguments mor
@DeclareFilter( "IsMorphismInQuotientCategoryOfLinearClosureOfPathCategory", FilterIntersection( IsQuotientCategoryMorphism, IsMorphismInFpLinearCategory ) );

#! @Description
#!  The filter for quotient categories of linear closures of quotients of path categories.
#! @Arguments kC
@DeclareFilter( "IsQuotientCategoryOfLinearClosureOfQuotientOfPathCategory", FilterIntersection( IsQuotientCategory, IsFpLinearCategory ) );
#! @Description
#!  The filter for objects in quotient categories of linear closures of quotients of path categories.
#! @Arguments obj

@DeclareFilter( "IsObjectInQuotientCategoryOfLinearClosureOfQuotientOfPathCategory", FilterIntersection( IsQuotientCategoryObject, IsObjectInFpLinearCategory ) );
#! @Description
#!  The filter for morphisms in quotient categories of linear closures of quotients of path categories.
#! @Arguments mor
@DeclareFilter( "IsMorphismInQuotientCategoryOfLinearClosureOfQuotientOfPathCategory", FilterIntersection( IsQuotientCategoryMorphism, IsMorphismInFpLinearCategory ) );
