...
function ( cat_1, alpha_1 )
    ...
    return IsBigInt( deduped_1_1 ) && deduped_1_1 >= 0 && deduped_1_1 < DataTables( cat_1 )[1][2];
end
########
...
function ( cat_1, arg2_1 )
    ...
    return IsBigInt( deduped_1_1 ) && deduped_1_1 >= 0 && deduped_1_1 < DataTables( cat_1 )[1][1];
end
########
...
@BindGlobal( "CategoryFromDataTablesPrecompiled", function ( quiver )
  local category_constructor, cat;
    ...
    return CategoryFromDataTables( PathCategory( quiver; range_of_HomStructure = sFinSets,
