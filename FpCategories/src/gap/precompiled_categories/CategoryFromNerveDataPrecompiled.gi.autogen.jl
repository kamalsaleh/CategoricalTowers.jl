...
function ( cat_1 )
    ...
    return List( IndicesOfGeneratingMorphisms( cat_1 ), function ( i_2 )
            return CreateMorphism( CreateCapCategoryObjectWithAttributes( cat_1, MapOfObject, CreateCapCategoryMorphismWithAttributes( deduped_8_1, deduped_3_1, deduped_4_1, AsList, [ BigInt( IntGAP( hoisted_1_1( i_2 ) ) ) ] ) ), i_2, CreateCapCategoryObjectWithAttributes( cat_1, MapOfObject, CreateCapCategoryMorphismWithAttributes( deduped_8_1, deduped_3_1, deduped_4_1, AsList, [ BigInt( IntGAP( hoisted_5_1( i_2 ) ) ) ] ) ) );
        end );
end
########
...
function ( cat_1 )
    ...
    return List( (0):(Length( deduped_6_1[2] ) - 1), function ( i_2 )
            return CreateMorphism( CreateCapCategoryObjectWithAttributes( cat_1, MapOfObject, CreateCapCategoryMorphismWithAttributes( deduped_9_1, deduped_3_1, deduped_4_1, AsList, [ BigInt( IntGAP( hoisted_1_1( i_2 ) ) ) ] ) ), i_2, CreateCapCategoryObjectWithAttributes( cat_1, MapOfObject, CreateCapCategoryMorphismWithAttributes( deduped_9_1, deduped_3_1, deduped_4_1, AsList, [ BigInt( IntGAP( hoisted_5_1( i_2 ) ) ) ] ) ) );
        end );
end
########
