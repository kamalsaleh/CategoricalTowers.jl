...
#! @Arguments category
@DeclareFilter( "IsCategoryFromDataTables",
        IsCapCategory );

#! @Description
#!  The &GAP; category of cells in a category from data tables.
#! @Arguments cell
@DeclareFilter( "IsCellInCategoryFromDataTables",
        IsCapCategoryCell );

#! @Description
#!  The &GAP; category of objects in a category from data tables.
#! @Arguments object
@DeclareFilter( "IsObjectInCategoryFromDataTables",
...
#! @Arguments morphism
@DeclareFilter( "IsMorphismInCategoryFromDataTables",
