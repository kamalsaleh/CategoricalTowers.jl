  ...
  function( input_record )
    ...
    SetDefiningTripleOfUnderlyingQuiver( C,
            Triple( C0,
                    ...
                    List( IndicesOfGeneratingMorphisms( C ), i -> PairGAP( s[1 + i], t[1 + i] ) ) ) );
...
@InstallMethod( DecompositionIndicesOfMorphism,
  ...
  function( C, mor )
    ...
    if (@not IsIdenticalObj( C, CapCategory( mor ) ))
...
@InstallMethod( LaTeXOutput,
  ...
  function( obj )
    ...
    return StringGAP( IndexOfObject( obj ) );
...
@InstallMethod( LaTeXOutput,
  ...
  function( mor )
    ...
    s = StringGAP( IndexOfMorphism( mor ) );
