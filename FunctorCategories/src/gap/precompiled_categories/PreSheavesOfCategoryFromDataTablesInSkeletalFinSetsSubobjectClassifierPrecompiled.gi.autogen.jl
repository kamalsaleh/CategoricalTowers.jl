...
function ( cat_1 )
            ...
            return CreateCapCategoryObjectWithAttributes( deduped_45_1, Cardinality, Length( Filtered( (0):(deduped_6_1 ^ deduped_6_2 - 1), function ( x_3 )
                        ...
                        return CAP_JIT_INCOMPLETE_LOGIC( Sum( List( deduped_2_2, function ( k_4 )
                                      return CAP_JIT_INCOMPLETE_LOGIC( CAP_JIT_EXPR_CASE_WRAPPER( function (  )
                                                    if ((CAP_JIT_INCOMPLETE_LOGIC( k_4 ) in hoisted_5_3))
                                                        return deduped_10_1;
                                                    else
                                                        return deduped_46_1;
                                                    end;
    ...
    return CreateCapCategoryObjectWithAttributes( cat_1, Source, deduped_44_1, Target, deduped_45_1, ValuesOfPreSheaf, @NTupleGAP( 2, deduped_33_1, List( (1):(deduped_41_1[2]), function ( m_2 )
