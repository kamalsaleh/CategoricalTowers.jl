...
# Implementations
#
@BindGlobal( "ADD_FUNCTIONS_FOR_PreSheavesOfFpCategoryDefinedByQuiverAlgebraInSkeletalFinSetsSubobjectClassifierPrecompiled", function ( cat )
...
function ( cat_1 )
            ...
            return CreateCapCategoryObjectWithAttributes( deduped_37_1, Cardinality, Length( Filtered( (0):(deduped_11_2 - 1), function ( x_3 )
                        ...
                        return Sum( List( deduped_10_2, function ( k_4 )
                                    return IdFunc( function (  )
                                                if ((CAP_JIT_INCOMPLETE_LOGIC( REM_INT( QUO_INT( hoisted_2_2, deduped_12_2 ^ CAP_JIT_INCOMPLETE_LOGIC( k_4 ) ), deduped_12_2 ) ) in hoisted_6_3))
                                                    return 1;
                                                else
                                                    return 0;
                                                end;
    ...
    return CreateCapCategoryObjectWithAttributes( cat_1, Source, deduped_36_1, Range, deduped_37_1, ValuesOfPreSheaf, @NTupleGAP( 2, deduped_28_1, List( (1):(deduped_32_1[2]), function ( m_2 )
...
@BindGlobal( "PreSheavesOfFpCategoryDefinedByQuiverAlgebraInSkeletalFinSetsSubobjectClassifierPrecompiled", function ( quiver )
  local category_constructor, cat;
    ...
    ADD_FUNCTIONS_FOR_PreSheavesOfFpCategoryDefinedByQuiverAlgebraInSkeletalFinSetsSubobjectClassifierPrecompiled( cat );
