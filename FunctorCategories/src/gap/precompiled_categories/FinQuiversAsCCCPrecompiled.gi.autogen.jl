...
function ( cat_1, a_1, b_1 )
    ...
    return CreateCapCategoryObjectWithAttributes( cat_1, DefiningTripleOfQuiverEnrichedOverSkeletalFinSets, @NTupleGAP( 3, Length( deduped_32_1 ), deduped_28_1, List( (0):(deduped_28_1 - 1), function ( x_2 )
                local deduped_1_2;
                deduped_1_2 = 1 + CAP_JIT_INCOMPLETE_LOGIC( deduped_29_1[(1 + CAP_JIT_INCOMPLETE_LOGIC( x_2 ))] );
                return @NTupleGAP( 2, -1 + BigInt( SafePosition( deduped_32_1, CAP_JIT_INCOMPLETE_LOGIC( deduped_25_1[(1 + Sum( deduped_42_1, function ( j_3 )
                                     local deduped_1_3;
                                     deduped_1_3 = (1 + j_3);
