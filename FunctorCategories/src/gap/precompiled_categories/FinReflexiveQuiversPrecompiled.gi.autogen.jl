...
function ( cat_1 )
    ...
    return CreateCapCategoryObjectWithAttributes( cat_1, DefiningQuadrupleOfReflexiveQuiverEnrichedOverSkeletalFinSets, @NTupleGAP( 4, deduped_1_1, deduped_1_1, CapJitTypedExpression( [  ], function (  )
                return @rec(
                    filter = IsList,
                    element_type = @rec(
                        filter = IsInt ) );
...
function ( cat_1, objects_1 )
    ...
    return CreateCapCategoryObjectWithAttributes( cat_1, DefiningQuadrupleOfReflexiveQuiverEnrichedOverSkeletalFinSets, @NTupleGAP( 4, Sum( deduped_3_1 ), Sum( deduped_4_1 ), @Concatenation( List( deduped_5_1, function ( i_2 )
...
function ( cat_1, objects_1 )
    ...
    return CreateCapCategoryObjectWithAttributes( cat_1, DefiningQuadrupleOfReflexiveQuiverEnrichedOverSkeletalFinSets, @NTupleGAP( 4, Sum( deduped_6_1 ), Sum( deduped_7_1 ), @Concatenation( List( deduped_8_1, function ( i_2 )
                  local hoisted_1_2, hoisted_2_2, deduped_3_2;
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_27_1 = Sum( [ deduped_34_1, deduped_36_1, deduped_36_1 ] );
    deduped_26_1 = @Concatenation( ListWithIdenticalEntries( deduped_34_1, deduped_35_1 ), ListWithIdenticalEntries( deduped_36_1, deduped_37_1 ) );
    deduped_25_1 = (1):(deduped_27_1);
    deduped_24_1 = ListWithIdenticalEntries( deduped_36_1, (0):(deduped_35_1 - 1) );
    deduped_23_1 = Product( deduped_26_1 );
    deduped_22_1 = (0):(deduped_27_1 - 1);
    deduped_21_1 = ListWithIdenticalEntries( deduped_36_1, deduped_23_1 );
    deduped_20_1 = (0):(deduped_23_1 - 1);
    deduped_4_1 = (deduped_34_1):(deduped_32_1 - 1);
    deduped_19_1 = List( deduped_31_1, function ( i_2 )
            ...
            hoisted_3_2 = DivIntWithGivenQuotient( deduped_23_1, deduped_4_2, deduped_5_2 * Product( deduped_26_1[(deduped_6_2 + 1):(deduped_32_1)] ) );
    ...
    hoisted_17_1 = @Concatenation( List( deduped_30_1, function ( i_2 )
              local hoisted_3_2, deduped_4_2, deduped_5_2, deduped_6_2;
              deduped_6_2 = 1 + i_2;
              deduped_5_2 = deduped_26_1[deduped_6_2];
              deduped_4_2 = Product( deduped_26_1[(1):(i_2)] );
              hoisted_3_2 = DivIntWithGivenQuotient( deduped_23_1, deduped_4_2, deduped_5_2 * Product( deduped_26_1[(deduped_6_2 + 1):(deduped_32_1)] ) );
              return List( deduped_20_1, function ( i_3 )
                      return RemIntWithDomain( QuoIntWithDomain( i_3, deduped_4_2, deduped_23_1 ), deduped_5_2, hoisted_3_2 );
                  end );
          end ), deduped_19_1, deduped_19_1 );
    hoisted_16_1 = @Concatenation( ListWithIdenticalEntries( deduped_34_1, deduped_28_1[SafeUniquePositionProperty( deduped_29_1, function ( mor_2 )
                 if (IndexOfObject( Source( mor_2 ) ) == 1 && IndexOfObject( Range( mor_2 ) ) == 0)
                 ...
                 if (IndexOfObject( Source( mor_2 ) ) == 0 && IndexOfObject( Range( mor_2 ) ) == 1)
    ...
    deduped_1_1 = @Concatenation( ListWithIdenticalEntries( deduped_34_1, deduped_23_1 ), deduped_21_1, deduped_21_1 );
    ...
    deduped_14_1 = List( deduped_25_1, function ( j_2 )
            return Product( hoisted_13_1[(1):(j_2 - 1)] );
        end );
    ...
    hoisted_2_1 = @Concatenation( ListWithIdenticalEntries( deduped_34_1, (0):(deduped_37_1 - 1) ), deduped_24_1, deduped_24_1 );
    ...
    return CreateCapCategoryObjectWithAttributes( RangeCategoryOfHomomorphismStructure( cat_1 ), Cardinality, BigInt( Length( Filtered( deduped_20_1, function ( x_2 )
                  local deduped_1_2;
                  deduped_1_2 = 1 + CAP_JIT_INCOMPLETE_LOGIC( x_2 );
                  return CAP_JIT_INCOMPLETE_LOGIC( Sum( deduped_25_1, function ( j_3 )
                              return hoisted_12_1[j_3][deduped_1_2] * deduped_14_1[j_3];
                          end ) ) == CAP_JIT_INCOMPLETE_LOGIC( Sum( deduped_25_1, function ( j_3 )
                              return hoisted_18_1[j_3][deduped_1_2] * deduped_14_1[j_3];
                          end ) );
              end ) ) ) );
end
########
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_43_1 = CreateCapCategoryObjectWithAttributes( deduped_46_1, IndexOfObject, 0 );
    deduped_42_1 = CreateCapCategoryObjectWithAttributes( deduped_46_1, IndexOfObject, 1 );
    deduped_41_1 = deduped_45_1[4];
    ...
    deduped_35_1 = ListWithIdenticalEntries( deduped_38_1, deduped_37_1 );
    deduped_34_1 = deduped_36_1 + deduped_38_1;
    deduped_33_1 = (0):(deduped_38_1 - 1);
    deduped_32_1 = (0):(deduped_36_1 - 1);
    deduped_31_1 = [ CreateCapCategoryMorphismWithAttributes( deduped_46_1, deduped_42_1, deduped_43_1, IndexOfMorphism, 1 ), CreateCapCategoryMorphismWithAttributes( deduped_46_1, deduped_43_1, deduped_42_1, IndexOfMorphism, 2 ), CreateCapCategoryMorphismWithAttributes( deduped_46_1, deduped_43_1, deduped_42_1, IndexOfMorphism, 3 ) ];
    deduped_30_1 = [ deduped_45_1[3], List( deduped_41_1, function ( a_2 )
                return a_2[1];
            end ), List( deduped_41_1, function ( a_2 )
                return a_2[2];
            end ) ];
    deduped_29_1 = Sum( [ deduped_36_1, deduped_38_1, deduped_38_1 ] );
    deduped_28_1 = @Concatenation( ListWithIdenticalEntries( deduped_36_1, deduped_37_1 ), ListWithIdenticalEntries( deduped_38_1, deduped_39_1 ) );
    deduped_27_1 = (1):(deduped_29_1);
    deduped_26_1 = ListWithIdenticalEntries( deduped_38_1, (0):(deduped_37_1 - 1) );
    deduped_25_1 = Product( deduped_28_1 );
    deduped_24_1 = (0):(deduped_29_1 - 1);
    deduped_23_1 = ListWithIdenticalEntries( deduped_38_1, deduped_25_1 );
    deduped_22_1 = (0):(deduped_25_1 - 1);
    deduped_4_1 = (deduped_36_1):(deduped_34_1 - 1);
    deduped_21_1 = List( deduped_33_1, function ( i_2 )
            local hoisted_3_2, deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
            deduped_7_2 = deduped_4_1[1 + i_2];
            deduped_6_2 = 1 + deduped_7_2;
            deduped_5_2 = deduped_28_1[deduped_6_2];
            deduped_4_2 = Product( deduped_28_1[(1):(deduped_7_2)] );
            hoisted_3_2 = DivIntWithGivenQuotient( deduped_25_1, deduped_4_2, deduped_5_2 * Product( deduped_28_1[(deduped_6_2 + 1):(deduped_34_1)] ) );
    ...
    hoisted_18_1 = @Concatenation( List( deduped_32_1, function ( i_2 )
              ...
              deduped_6_2 = 1 + i_2;
              deduped_5_2 = deduped_28_1[deduped_6_2];
              deduped_4_2 = Product( deduped_28_1[(1):(i_2)] );
              hoisted_3_2 = DivIntWithGivenQuotient( deduped_25_1, deduped_4_2, deduped_5_2 * Product( deduped_28_1[(deduped_6_2 + 1):(deduped_34_1)] ) );
              return List( deduped_22_1, function ( i_3 )
                      return RemIntWithDomain( QuoIntWithDomain( i_3, deduped_4_2, deduped_25_1 ), deduped_5_2, hoisted_3_2 );
                  end );
          end ), deduped_21_1, deduped_21_1 );
    hoisted_17_1 = @Concatenation( ListWithIdenticalEntries( deduped_36_1, deduped_30_1[SafeUniquePositionProperty( deduped_31_1, function ( mor_2 )
                 if (IndexOfObject( Source( mor_2 ) ) == 1 && IndexOfObject( Range( mor_2 ) ) == 0)
                     return IndexOfMorphism( mor_2 ) == 1;
                 else
                     return false;
                 ...
                 return;
             end )] ), ListWithIdenticalEntries( deduped_38_1, deduped_30_1[SafeUniquePositionProperty( deduped_31_1, function ( mor_2 )
                 if (IndexOfObject( Source( mor_2 ) ) == 0 && IndexOfObject( Range( mor_2 ) ) == 1)
                     return IndexOfMorphism( mor_2 ) == 2;
                 else
                     return false;
    ...
    deduped_1_1 = @Concatenation( ListWithIdenticalEntries( deduped_36_1, deduped_25_1 ), deduped_23_1, deduped_23_1 );
    ...
    hoisted_13_1 = @Concatenation( ListWithIdenticalEntries( deduped_36_1, deduped_39_1 ), deduped_35_1, deduped_35_1 );
    deduped_14_1 = List( deduped_27_1, function ( j_2 )
            return Product( hoisted_13_1[(1):(j_2 - 1)] );
        end );
    hoisted_20_1 = List( deduped_22_1, function ( i_2 )
            ...
            return Sum( deduped_27_1, function ( j_3 )
                    return hoisted_19_1[j_3][hoisted_1_2] * deduped_14_1[j_3];
                end );
        end );
    hoisted_10_1 = List( deduped_40_1, function ( a_2 )
            return a_2[2];
        end );
    hoisted_9_1 = List( deduped_40_1, function ( a_2 )
            return a_2[1];
        end );
    hoisted_3_1 = deduped_44_1[3];
    hoisted_11_1 = @Concatenation( List( deduped_32_1, function ( i_2 )
              local hoisted_3_2, deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
              deduped_7_2 = deduped_4_1[1 + hoisted_3_1[1 + i_2]];
              deduped_6_2 = 1 + deduped_7_2;
              deduped_5_2 = deduped_28_1[deduped_6_2];
    ...
    hoisted_2_1 = @Concatenation( ListWithIdenticalEntries( deduped_36_1, (0):(deduped_39_1 - 1) ), deduped_26_1, deduped_26_1 );
    ...
    hoisted_16_1 = List( deduped_22_1, function ( i_2 )
            ...
            hoisted_1_2 = 1 + i_2;
            return Sum( deduped_27_1, function ( j_3 )
                    return hoisted_12_1[j_3][hoisted_1_2] * deduped_14_1[j_3];
                end );
        end );
    return CreateCapCategoryObjectWithAttributes( RangeCategoryOfHomomorphismStructure( cat_1 ), Cardinality, BigInt( Length( Filtered( deduped_22_1, function ( x_2 )
                  local deduped_1_2;
                  deduped_1_2 = 1 + x_2;
...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    deduped_49_1 = CreateCapCategoryObjectWithAttributes( deduped_52_1, IndexOfObject, 0 );
    deduped_48_1 = CreateCapCategoryObjectWithAttributes( deduped_52_1, IndexOfObject, 1 );
    deduped_47_1 = deduped_51_1[4];
    ...
    deduped_40_1 = deduped_42_1 + deduped_43_1;
    deduped_39_1 = (0):(deduped_43_1 - 1);
    deduped_38_1 = (0):(deduped_42_1 - 1);
    deduped_37_1 = [ CreateCapCategoryMorphismWithAttributes( deduped_52_1, deduped_48_1, deduped_49_1, IndexOfMorphism, 1 ), CreateCapCategoryMorphismWithAttributes( deduped_52_1, deduped_49_1, deduped_48_1, IndexOfMorphism, 2 ), CreateCapCategoryMorphismWithAttributes( deduped_52_1, deduped_49_1, deduped_48_1, IndexOfMorphism, 3 ) ];
    deduped_36_1 = [ deduped_51_1[3], List( deduped_47_1, function ( a_2 )
                return a_2[1];
            end ), List( deduped_47_1, function ( a_2 )
                return a_2[2];
            end ) ];
    deduped_35_1 = Sum( [ deduped_42_1, deduped_43_1, deduped_43_1 ] );
    deduped_34_1 = @Concatenation( ListWithIdenticalEntries( deduped_42_1, deduped_44_1 ), ListWithIdenticalEntries( deduped_43_1, deduped_45_1 ) );
    deduped_33_1 = (1):(deduped_35_1);
    deduped_32_1 = ListWithIdenticalEntries( deduped_43_1, (0):(deduped_44_1 - 1) );
    deduped_31_1 = Product( deduped_34_1 );
    deduped_30_1 = (0):(deduped_35_1 - 1);
    deduped_29_1 = Product( deduped_34_1[(1):(deduped_42_1)] );
    deduped_28_1 = ListWithIdenticalEntries( deduped_43_1, deduped_31_1 );
    deduped_27_1 = (0):(deduped_31_1 - 1);
    deduped_4_1 = (deduped_42_1):(deduped_40_1 - 1);
    deduped_25_1 = List( deduped_39_1, function ( i_2 )
            local hoisted_3_2, deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
            deduped_7_2 = deduped_4_1[1 + i_2];
            deduped_6_2 = 1 + deduped_7_2;
            deduped_5_2 = deduped_34_1[deduped_6_2];
            deduped_4_2 = Product( deduped_34_1[(1):(deduped_7_2)] );
            hoisted_3_2 = DivIntWithGivenQuotient( deduped_31_1, deduped_4_2, deduped_5_2 * Product( deduped_34_1[(deduped_6_2 + 1):(deduped_40_1)] ) );
    ...
    hoisted_17_1 = @Concatenation( List( deduped_38_1, function ( i_2 )
              local hoisted_3_2, deduped_4_2, deduped_5_2, deduped_6_2;
              deduped_6_2 = 1 + i_2;
              deduped_5_2 = deduped_34_1[deduped_6_2];
          ...
          end ), deduped_25_1, deduped_25_1 );
    hoisted_16_1 = @Concatenation( ListWithIdenticalEntries( deduped_42_1, deduped_36_1[SafeUniquePositionProperty( deduped_37_1, function ( mor_2 )
                 if (IndexOfObject( Source( mor_2 ) ) == 1 && IndexOfObject( Range( mor_2 ) ) == 0)
                     return IndexOfMorphism( mor_2 ) == 1;
                 else
                     return false;
                 ...
                 return;
             end )] ), ListWithIdenticalEntries( deduped_43_1, deduped_36_1[SafeUniquePositionProperty( deduped_37_1, function ( mor_2 )
                 if (IndexOfObject( Source( mor_2 ) ) == 0 && IndexOfObject( Range( mor_2 ) ) == 1)
                     return IndexOfMorphism( mor_2 ) == 2;
                 else
                     return false;
    ...
    deduped_1_1 = @Concatenation( ListWithIdenticalEntries( deduped_42_1, deduped_31_1 ), deduped_28_1, deduped_28_1 );
    ...
    hoisted_13_1 = @Concatenation( ListWithIdenticalEntries( deduped_42_1, deduped_45_1 ), deduped_41_1, deduped_41_1 );
    deduped_14_1 = List( deduped_33_1, function ( j_2 )
            return Product( hoisted_13_1[(1):(j_2 - 1)] );
        end );
    hoisted_10_1 = List( deduped_46_1, function ( a_2 )
            return a_2[2];
        end );
    hoisted_9_1 = List( deduped_46_1, function ( a_2 )
            return a_2[1];
        end );
    hoisted_3_1 = deduped_50_1[3];
    hoisted_11_1 = @Concatenation( List( deduped_38_1, function ( i_2 )
              local hoisted_3_2, deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
              deduped_7_2 = deduped_4_1[1 + hoisted_3_1[1 + i_2]];
              deduped_6_2 = 1 + deduped_7_2;
              deduped_5_2 = deduped_34_1[deduped_6_2];
    ...
    hoisted_2_1 = @Concatenation( ListWithIdenticalEntries( deduped_42_1, (0):(deduped_45_1 - 1) ), deduped_32_1, deduped_32_1 );
    ...
    deduped_26_1 = CAP_JIT_INCOMPLETE_LOGIC( Filtered( deduped_27_1, function ( x_2 )
                local deduped_1_2;
                deduped_1_2 = 1 + CAP_JIT_INCOMPLETE_LOGIC( x_2 );
    ...
    hoisted_22_1 = CAP_JIT_INCOMPLETE_LOGIC( QuoIntWithDomain( deduped_26_1, deduped_29_1, deduped_31_1 ) );
    hoisted_19_1 = CAP_JIT_INCOMPLETE_LOGIC( RemIntWithDomain( deduped_26_1, deduped_29_1, deduped_31_1 ) );
    return CreateCapCategoryMorphismWithAttributes( cat_1, source_1, range_1, DefiningPairOfReflexiveQuiverMorphismEnrichedOverSkeletalFinSets, @NTupleGAP( 2, List( deduped_38_1, function ( i_2 )
                return DigitInPositionalNotation( hoisted_19_1, i_2, deduped_42_1, deduped_44_1 );
            end ), List( deduped_39_1, function ( i_2 )
                return DigitInPositionalNotation( hoisted_22_1, i_2, deduped_43_1, deduped_45_1 );
            end ) ) );
end
########
...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    deduped_57_1 = DefiningQuadrupleOfReflexiveQuiverEnrichedOverSkeletalFinSets( range_1 );
    deduped_56_1 = DefiningQuadrupleOfReflexiveQuiverEnrichedOverSkeletalFinSets( source_1 );
    deduped_55_1 = CreateCapCategoryObjectWithAttributes( deduped_58_1, IndexOfObject, 0 );
    deduped_54_1 = CreateCapCategoryObjectWithAttributes( deduped_58_1, IndexOfObject, 1 );
    deduped_53_1 = deduped_57_1[4];
    deduped_52_1 = deduped_56_1[4];
    deduped_51_1 = deduped_57_1[2];
    deduped_50_1 = deduped_57_1[1];
    deduped_49_1 = deduped_56_1[2];
    deduped_48_1 = deduped_56_1[1];
    deduped_47_1 = ListWithIdenticalEntries( deduped_49_1, deduped_50_1 );
    deduped_46_1 = deduped_48_1 + deduped_49_1;
    deduped_45_1 = (0):(Cardinality( Source( alpha_1 ) ) - 1);
    deduped_44_1 = (0):(deduped_49_1 - 1);
    deduped_43_1 = (0):(deduped_48_1 - 1);
    deduped_42_1 = [ CreateCapCategoryMorphismWithAttributes( deduped_58_1, deduped_54_1, deduped_55_1, IndexOfMorphism, 1 ), CreateCapCategoryMorphismWithAttributes( deduped_58_1, deduped_55_1, deduped_54_1, IndexOfMorphism, 2 ), CreateCapCategoryMorphismWithAttributes( deduped_58_1, deduped_55_1, deduped_54_1, IndexOfMorphism, 3 ) ];
    deduped_41_1 = [ deduped_57_1[3], List( deduped_53_1, function ( a_2 )
                return a_2[1];
            end ), List( deduped_53_1, function ( a_2 )
                return a_2[2];
            end ) ];
    deduped_40_1 = Sum( [ deduped_48_1, deduped_49_1, deduped_49_1 ] );
    deduped_39_1 = @Concatenation( ListWithIdenticalEntries( deduped_48_1, deduped_50_1 ), ListWithIdenticalEntries( deduped_49_1, deduped_51_1 ) );
    deduped_38_1 = (1):(deduped_40_1);
    deduped_37_1 = ListWithIdenticalEntries( deduped_49_1, (0):(deduped_50_1 - 1) );
    deduped_36_1 = Product( deduped_39_1 );
    deduped_35_1 = (0):(deduped_40_1 - 1);
    deduped_34_1 = ListWithIdenticalEntries( deduped_49_1, deduped_36_1 );
    deduped_33_1 = (0):(deduped_36_1 - 1);
    deduped_6_1 = (deduped_48_1):(deduped_46_1 - 1);
    deduped_32_1 = List( deduped_44_1, function ( i_2 )
            local hoisted_3_2, deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
            deduped_7_2 = deduped_6_1[1 + i_2];
            deduped_6_2 = 1 + deduped_7_2;
            deduped_5_2 = deduped_39_1[deduped_6_2];
            deduped_4_2 = Product( deduped_39_1[(1):(deduped_7_2)] );
            hoisted_3_2 = DivIntWithGivenQuotient( deduped_36_1, deduped_4_2, deduped_5_2 * Product( deduped_39_1[(deduped_6_2 + 1):(deduped_46_1)] ) );
    ...
    deduped_1_1 = Product( deduped_39_1[(1):(deduped_48_1)] );
    hoisted_28_1 = List( deduped_33_1, function ( i_2 )
            return QuoIntWithDomain( i_2, deduped_1_1, deduped_36_1 );
        end );
    hoisted_19_1 = @Concatenation( List( deduped_43_1, function ( i_2 )
              local hoisted_3_2, deduped_4_2, deduped_5_2, deduped_6_2;
              deduped_6_2 = 1 + i_2;
              deduped_5_2 = deduped_39_1[deduped_6_2];
              deduped_4_2 = Product( deduped_39_1[(1):(i_2)] );
              hoisted_3_2 = DivIntWithGivenQuotient( deduped_36_1, deduped_4_2, deduped_5_2 * Product( deduped_39_1[(deduped_6_2 + 1):(deduped_46_1)] ) );
              return List( deduped_33_1, function ( i_3 )
                      return RemIntWithDomain( QuoIntWithDomain( i_3, deduped_4_2, deduped_36_1 ), deduped_5_2, hoisted_3_2 );
                  end );
          end ), deduped_32_1, deduped_32_1 );
    hoisted_18_1 = @Concatenation( ListWithIdenticalEntries( deduped_48_1, deduped_41_1[SafeUniquePositionProperty( deduped_42_1, function ( mor_2 )
                 if (IndexOfObject( Source( mor_2 ) ) == 1 && IndexOfObject( Range( mor_2 ) ) == 0)
                     return IndexOfMorphism( mor_2 ) == 1;
                 else
                     return false;
                 ...
                 return;
             end )] ), ListWithIdenticalEntries( deduped_49_1, deduped_41_1[SafeUniquePositionProperty( deduped_42_1, function ( mor_2 )
                 if (IndexOfObject( Source( mor_2 ) ) == 0 && IndexOfObject( Range( mor_2 ) ) == 1)
                     return IndexOfMorphism( mor_2 ) == 2;
                 else
                     return false;
    ...
    deduped_3_1 = @Concatenation( ListWithIdenticalEntries( deduped_48_1, deduped_36_1 ), deduped_34_1, deduped_34_1 );
    ...
    hoisted_14_1 = @Concatenation( ListWithIdenticalEntries( deduped_48_1, deduped_51_1 ), deduped_47_1, deduped_47_1 );
    deduped_15_1 = List( deduped_38_1, function ( j_2 )
            return Product( hoisted_14_1[(1):(j_2 - 1)] );
        end );
    hoisted_21_1 = List( deduped_33_1, function ( i_2 )
            local hoisted_1_2;
            hoisted_1_2 = 1 + i_2;
            return Sum( deduped_38_1, function ( j_3 )
                    return hoisted_20_1[j_3][hoisted_1_2] * deduped_15_1[j_3];
                end );
        end );
    hoisted_11_1 = List( deduped_52_1, function ( a_2 )
            return a_2[2];
        end );
    hoisted_10_1 = List( deduped_52_1, function ( a_2 )
            return a_2[1];
        end );
    hoisted_5_1 = deduped_56_1[3];
    hoisted_12_1 = @Concatenation( List( deduped_43_1, function ( i_2 )
              local hoisted_3_2, deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
    ...
    hoisted_4_1 = @Concatenation( ListWithIdenticalEntries( deduped_48_1, (0):(deduped_51_1 - 1) ), deduped_37_1, deduped_37_1 );
    ...
    hoisted_17_1 = List( deduped_33_1, function ( i_2 )
            ...
            hoisted_1_2 = 1 + i_2;
            return Sum( deduped_38_1, function ( j_3 )
                    return hoisted_13_1[j_3][hoisted_1_2] * deduped_15_1[j_3];
                end );
        end );
    ...
    hoisted_25_1 = List( deduped_45_1, function ( i_2 )
              return hoisted_24_1[1 + deduped_23_1[1 + deduped_22_1[1 + i_2]]];
          end )[1];
    return CreateCapCategoryMorphismWithAttributes( cat_1, source_1, range_1, DefiningPairOfReflexiveQuiverMorphismEnrichedOverSkeletalFinSets, @NTupleGAP( 2, List( deduped_43_1, function ( i_2 )
                return DigitInPositionalNotation( hoisted_25_1, i_2, deduped_48_1, deduped_50_1 );
            end ), List( deduped_44_1, function ( i_2 )
                return DigitInPositionalNotation( hoisted_29_1, i_2, deduped_49_1, deduped_51_1 );
            end ) ) );
end
########
...
########
function ( cat_1, arg2_1, arg3_1 )
    local deduped_1_1, hoisted_2_1, hoisted_3_1, deduped_4_1, hoisted_9_1, hoisted_10_1, hoisted_11_1, hoisted_12_1, hoisted_13_1, deduped_14_1, hoisted_16_1, hoisted_17_1, hoisted_18_1, deduped_19_1, hoisted_21_1, hoisted_25_1, deduped_29_1, deduped_30_1, deduped_31_1, deduped_32_1, deduped_33_1, deduped_34_1, deduped_35_1, deduped_36_1, deduped_37_1, deduped_38_1, deduped_39_1, deduped_40_1, deduped_41_1, deduped_42_1, deduped_43_1, deduped_44_1, deduped_45_1, deduped_46_1, deduped_47_1, deduped_48_1, deduped_49_1, deduped_50_1, deduped_51_1, deduped_52_1, deduped_53_1, deduped_54_1, deduped_55_1;
    ...
    deduped_38_1 = Sum( [ deduped_45_1, deduped_47_1, deduped_47_1 ] );
    deduped_37_1 = @Concatenation( ListWithIdenticalEntries( deduped_45_1, deduped_46_1 ), ListWithIdenticalEntries( deduped_47_1, deduped_48_1 ) );
    deduped_36_1 = (1):(deduped_38_1);
    deduped_35_1 = ListWithIdenticalEntries( deduped_47_1, (0):(deduped_46_1 - 1) );
    deduped_34_1 = Product( deduped_37_1 );
    deduped_33_1 = (0):(deduped_38_1 - 1);
    deduped_32_1 = ListWithIdenticalEntries( deduped_47_1, deduped_34_1 );
    deduped_31_1 = (0):(deduped_34_1 - 1);
    deduped_4_1 = (deduped_45_1):(deduped_43_1 - 1);
    deduped_29_1 = List( deduped_42_1, function ( i_2 )
            local hoisted_3_2, deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
            deduped_7_2 = deduped_4_1[1 + i_2];
            deduped_6_2 = 1 + deduped_7_2;
            deduped_5_2 = deduped_37_1[deduped_6_2];
            deduped_4_2 = Product( deduped_37_1[(1):(deduped_7_2)] );
            hoisted_3_2 = DivIntWithGivenQuotient( deduped_34_1, deduped_4_2, deduped_5_2 * Product( deduped_37_1[(deduped_6_2 + 1):(deduped_43_1)] ) );
    ...
    hoisted_17_1 = @Concatenation( List( deduped_41_1, function ( i_2 )
              local hoisted_3_2, deduped_4_2, deduped_5_2, deduped_6_2;
              deduped_6_2 = 1 + i_2;
              deduped_5_2 = deduped_37_1[deduped_6_2];
              deduped_4_2 = Product( deduped_37_1[(1):(i_2)] );
              hoisted_3_2 = DivIntWithGivenQuotient( deduped_34_1, deduped_4_2, deduped_5_2 * Product( deduped_37_1[(deduped_6_2 + 1):(deduped_43_1)] ) );
              return List( deduped_31_1, function ( i_3 )
                      return RemIntWithDomain( QuoIntWithDomain( i_3, deduped_4_2, deduped_34_1 ), deduped_5_2, hoisted_3_2 );
                  end );
          end ), deduped_29_1, deduped_29_1 );
    hoisted_16_1 = @Concatenation( ListWithIdenticalEntries( deduped_45_1, deduped_39_1[SafeUniquePositionProperty( deduped_40_1, function ( mor_2 )
                 if (IndexOfObject( Source( mor_2 ) ) == 1 && IndexOfObject( Range( mor_2 ) ) == 0)
                     return IndexOfMorphism( mor_2 ) == 1;
                 else
                     return false;
    ...
    deduped_1_1 = @Concatenation( ListWithIdenticalEntries( deduped_45_1, deduped_34_1 ), deduped_32_1, deduped_32_1 );
    ...
    deduped_14_1 = List( deduped_36_1, function ( j_2 )
            return Product( hoisted_13_1[(1):(j_2 - 1)] );
        end );
    ...
    hoisted_2_1 = @Concatenation( ListWithIdenticalEntries( deduped_45_1, (0):(deduped_48_1 - 1) ), deduped_35_1, deduped_35_1 );
    hoisted_12_1 = List( deduped_33_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
            deduped_3_2 = 1 + i_2;
            hoisted_2_2 = hoisted_2_1[deduped_3_2];
            hoisted_1_2 = hoisted_11_1[deduped_3_2];
    ...
    deduped_19_1 = Product( deduped_37_1[(1):(deduped_45_1)] );
    hoisted_25_1 = List( deduped_31_1, function ( i_2 )
            return QuoIntWithDomain( i_2, deduped_19_1, deduped_34_1 );
        end );
    hoisted_21_1 = List( deduped_31_1, function ( i_2 )
            return RemIntWithDomain( i_2, deduped_19_1, deduped_34_1 );
        end );
    return List( (0):(BigInt( Length( deduped_30_1 ) ) - 1), function ( i_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
            deduped_3_2 = 1 + deduped_30_1[1 + i_2];
            hoisted_2_2 = hoisted_25_1[deduped_3_2];
            hoisted_1_2 = hoisted_21_1[deduped_3_2];
            return CreateCapCategoryMorphismWithAttributes( cat_1, arg2_1, arg3_1, DefiningPairOfReflexiveQuiverMorphismEnrichedOverSkeletalFinSets, @NTupleGAP( 2, List( deduped_41_1, function ( i_3 )
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_56_1 = DefiningQuadrupleOfReflexiveQuiverEnrichedOverSkeletalFinSets( arg3_1 );
    deduped_55_1 = DefiningQuadrupleOfReflexiveQuiverEnrichedOverSkeletalFinSets( arg2_1 );
    deduped_54_1 = CreateCapCategoryObjectWithAttributes( deduped_57_1, IndexOfObject, 0 );
    deduped_53_1 = CreateCapCategoryObjectWithAttributes( deduped_57_1, IndexOfObject, 1 );
    deduped_52_1 = deduped_56_1[4];
    ...
    deduped_46_1 = ListWithIdenticalEntries( deduped_49_1, deduped_48_1 );
    deduped_45_1 = deduped_47_1 + deduped_49_1;
    deduped_44_1 = (0):(deduped_49_1 - 1);
    deduped_43_1 = (0):(deduped_47_1 - 1);
    deduped_42_1 = [ CreateCapCategoryMorphismWithAttributes( deduped_57_1, deduped_53_1, deduped_54_1, IndexOfMorphism, 1 ), CreateCapCategoryMorphismWithAttributes( deduped_57_1, deduped_54_1, deduped_53_1, IndexOfMorphism, 2 ), CreateCapCategoryMorphismWithAttributes( deduped_57_1, deduped_54_1, deduped_53_1, IndexOfMorphism, 3 ) ];
    deduped_41_1 = [ deduped_56_1[3], List( deduped_52_1, function ( a_2 )
                return a_2[1];
            end ), List( deduped_52_1, function ( a_2 )
                return a_2[2];
            end ) ];
    deduped_40_1 = Sum( [ deduped_47_1, deduped_49_1, deduped_49_1 ] );
    deduped_39_1 = @Concatenation( ListWithIdenticalEntries( deduped_47_1, deduped_48_1 ), ListWithIdenticalEntries( deduped_49_1, deduped_50_1 ) );
    deduped_38_1 = (1):(deduped_40_1);
    deduped_37_1 = ListWithIdenticalEntries( deduped_49_1, (0):(deduped_48_1 - 1) );
    deduped_36_1 = Product( deduped_39_1 );
    deduped_35_1 = (0):(deduped_40_1 - 1);
    deduped_34_1 = ListWithIdenticalEntries( deduped_49_1, deduped_36_1 );
    deduped_33_1 = (0):(deduped_36_1 - 1);
    deduped_4_1 = (deduped_47_1):(deduped_45_1 - 1);
    deduped_31_1 = List( deduped_44_1, function ( i_2 )
            local hoisted_3_2, deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
            deduped_7_2 = deduped_4_1[1 + i_2];
            deduped_6_2 = 1 + deduped_7_2;
            deduped_5_2 = deduped_39_1[deduped_6_2];
            deduped_4_2 = Product( deduped_39_1[(1):(deduped_7_2)] );
            hoisted_3_2 = DivIntWithGivenQuotient( deduped_36_1, deduped_4_2, deduped_5_2 * Product( deduped_39_1[(deduped_6_2 + 1):(deduped_45_1)] ) );
            return List( deduped_33_1, function ( i_3 )
                    return RemIntWithDomain( QuoIntWithDomain( i_3, deduped_4_2, deduped_36_1 ), deduped_5_2, hoisted_3_2 );
                end );
        end );
    ...
    hoisted_17_1 = @Concatenation( ListWithIdenticalEntries( deduped_47_1, deduped_41_1[SafeUniquePositionProperty( deduped_42_1, function ( mor_2 )
                 if (IndexOfObject( Source( mor_2 ) ) == 1 && IndexOfObject( Range( mor_2 ) ) == 0)
                     return IndexOfMorphism( mor_2 ) == 1;
                 else
                     return false;
    ...
    deduped_1_1 = @Concatenation( ListWithIdenticalEntries( deduped_47_1, deduped_36_1 ), deduped_34_1, deduped_34_1 );
    ...
    hoisted_13_1 = @Concatenation( ListWithIdenticalEntries( deduped_47_1, deduped_50_1 ), deduped_46_1, deduped_46_1 );
    deduped_14_1 = List( deduped_38_1, function ( j_2 )
            return Product( hoisted_13_1[(1):(j_2 - 1)] );
        end );
    ...
    hoisted_10_1 = List( deduped_51_1, function ( a_2 )
            return a_2[2];
        end );
    hoisted_9_1 = List( deduped_51_1, function ( a_2 )
            return a_2[1];
        end );
    hoisted_3_1 = deduped_55_1[3];
    hoisted_11_1 = @Concatenation( List( deduped_43_1, function ( i_2 )
              local hoisted_3_2, deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
              deduped_7_2 = deduped_4_1[1 + hoisted_3_1[1 + i_2]];
              deduped_6_2 = 1 + deduped_7_2;
              deduped_5_2 = deduped_39_1[deduped_6_2];
    ...
    hoisted_2_1 = @Concatenation( ListWithIdenticalEntries( deduped_47_1, (0):(deduped_50_1 - 1) ), deduped_37_1, deduped_37_1 );
    ...
    deduped_21_1 = Product( deduped_39_1[(1):(deduped_47_1)] );
    ...
    return List( (0):(BigInt( Length( deduped_32_1 ) ) - 1), function ( i_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
            deduped_3_2 = 1 + deduped_32_1[1 + i_2];
            hoisted_2_2 = hoisted_27_1[deduped_3_2];
            hoisted_1_2 = hoisted_23_1[deduped_3_2];
            return CreateCapCategoryMorphismWithAttributes( cat_1, arg2_1, arg3_1, DefiningPairOfReflexiveQuiverMorphismEnrichedOverSkeletalFinSets, @NTupleGAP( 2, List( deduped_43_1, function ( i_3 )
                        return DigitInPositionalNotation( hoisted_1_2, i_3, deduped_47_1, deduped_48_1 );
                    end ), List( deduped_44_1, function ( i_3 )
                        return DigitInPositionalNotation( hoisted_2_2, i_3, deduped_49_1, deduped_50_1 );
                    end ) ) );
        end );
end
########
