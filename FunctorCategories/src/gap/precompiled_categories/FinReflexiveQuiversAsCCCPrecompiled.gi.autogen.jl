...
function ( cat_1, a_1, b_1 )
    ...
    return CreateCapCategoryObjectWithAttributes( cat_1, DefiningQuadrupleOfReflexiveQuiverEnrichedOverSkeletalFinSets, @NTupleGAP( 4, deduped_56_1, deduped_57_1, List( (0):(deduped_56_1 - 1), function ( x_2 )
                local hoisted_1_2;
                ...
                return @NTupleGAP( 2, -1 + BigInt( SafePosition( deduped_58_1, CAP_JIT_INCOMPLETE_LOGIC( deduped_53_1[(1 + Sum( deduped_80_1, function ( j_3 )
                                     local deduped_1_3;
                                     deduped_1_3 = (1 + j_3);
