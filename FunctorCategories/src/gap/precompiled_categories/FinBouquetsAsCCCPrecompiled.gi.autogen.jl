...
function ( cat_1, a_1, b_1 )
    ...
    return CreateCapCategoryObjectWithAttributes( cat_1, DefiningTripleOfBouquetEnrichedOverSkeletalFinSets, @NTupleGAP( 3, Length( deduped_24_1 ), deduped_22_1, List( (0):(deduped_22_1 - 1), function ( x_2 )
                local hoisted_1_2;
