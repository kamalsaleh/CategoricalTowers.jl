...
InstallMethodWithCache( FreeDistributiveCompletion,
  ...
  function( fp_category, range_category_of_hom_structure )
    ...
    ##
    category_filter = IsFreeDistributiveCompletion && IsWrapperCapCategory;
    category_object_filter = IsObjectInFreeDistributiveCompletion && IsWrapperCapCategoryObject;
    category_morphism_filter = IsMorphismInFreeDistributiveCompletion && IsWrapperCapCategoryMorphism;
