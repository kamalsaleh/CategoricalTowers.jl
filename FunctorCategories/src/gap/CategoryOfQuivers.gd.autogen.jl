...
#! @Arguments category
@DeclareFilter( "IsCategoryOfQuivers",
        IsCapCategory );

#! @Description
#!  The &GAP; category of cells in the category of quivers.
#! @Arguments cell
@DeclareFilter( "IsCellInCategoryOfQuivers",
        IsCapCategoryCell );

#! @Description
#!  The &GAP; category of objects in the category of quivers.
#! @Arguments obj
@DeclareFilter( "IsObjectInCategoryOfQuivers",
        FilterIntersection( IsCapCategoryObject, IsCellInCategoryOfQuivers ) );

#! @Description
#!  The &GAP; category of morphisms in the category of quivers.
#! @Arguments mor
@DeclareFilter( "IsMorphismInCategoryOfQuivers",
        FilterIntersection( IsCapCategoryMorphism, IsCellInCategoryOfQuivers ) );
