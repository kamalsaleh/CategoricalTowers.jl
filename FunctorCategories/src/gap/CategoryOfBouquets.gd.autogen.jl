...
#! @Arguments category
@DeclareFilter( "IsCategoryOfBouquets",
        IsCapCategory );

#! @Description
#!  The &GAP; category of cells in the category of bouquets.
#! @Arguments cell
@DeclareFilter( "IsCellInCategoryOfBouquets",
        IsCapCategoryCell );

#! @Description
#!  The &GAP; category of objects in the category of bouquets.
#! @Arguments obj
@DeclareFilter( "IsObjectInCategoryOfBouquets",
...
#! @Arguments mor
@DeclareFilter( "IsMorphismInCategoryOfBouquets",
