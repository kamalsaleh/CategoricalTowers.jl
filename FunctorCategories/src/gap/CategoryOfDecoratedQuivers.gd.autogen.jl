...
#! @Arguments category
@DeclareFilter( "IsCategoryOfDecoratedQuivers",
        IsCapCategory );

#! @Description
#!  The &GAP; category of cells in the category of quivers.
#! @Arguments cell
@DeclareFilter( "IsCellInCategoryOfDecoratedQuivers",
        IsCapCategoryCell );

#! @Description
#!  The &GAP; category of objects in the category of quivers.
#! @Arguments obj
@DeclareFilter( "IsObjectInCategoryOfDecoratedQuivers",
        FilterIntersection( IsCapCategoryObject, IsCellInCategoryOfDecoratedQuivers ) );

#! @Description
#!  The &GAP; category of morphisms in the category of quivers.
#! @Arguments mor
@DeclareFilter( "IsMorphismInCategoryOfDecoratedQuivers",
        FilterIntersection( IsCapCategoryMorphism, IsCellInCategoryOfDecoratedQuivers ) );
...
@DeclareOperation( "CategoryOfDecoratedQuivers",
