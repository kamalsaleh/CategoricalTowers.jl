...
julia> # extracted from examples/SkeletalEqualizer.g
...
julia> S = ObjectConstructor( sFinSets, 5 )
|5|

julia> T = ObjectConstructor( sFinSets, 3 )
|3|

julia> f1 = MorphismConstructor( S, [ 2, 2, 0, 1, 1 ], T )
|5| → |3|

julia> f2 = MorphismConstructor( S, [ 2, 1, 2, 0, 1 ], T )
|5| → |3|

julia> f3 = MorphismConstructor( S, [ 2, 0, 1, 0, 1 ], T )
|5| → |3|
...
julia> phi = MorphismConstructor( ObjectConstructor( sFinSets, 2 ), [ 4, 0 ], S );
