...
@DeclareFilter( "IsFiniteStrictCoproductCompletionOfObjectFiniteCategory",
        IsCapCategory );

#! @Description
#!  The &GAP; category of cells in a finite coproduct completion of an object-finite category.
@DeclareFilter( "IsCellInFiniteStrictCoproductCompletionOfObjectFiniteCategory",
        IsCapCategoryCell );

#! @Description
#!  The &GAP; category of objects in a finite coproduct completion of an object-finite category.
@DeclareFilter( "IsObjectInFiniteStrictCoproductCompletionOfObjectFiniteCategory",
...
@DeclareFilter( "IsMorphismInFiniteStrictCoproductCompletionOfObjectFiniteCategory",
...
# =#
@DeclareFilterDispatchedOperation( "ExtendFunctorToFiniteStrictCoproductCompletionOfObjectFiniteCategoryData", [ IsFiniteStrictCoproductCompletionOfObjectFiniteCategory, IsList, IsCapCategory ] );
