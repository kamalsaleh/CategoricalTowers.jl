...
@DeclareFilter( "IsMorphismInFreeDistributiveCategoryWithStrictProductAndCoproducts",
...
# =#
@DeclareFilterDispatchedOperation( "ExtendFunctorToFreeDistributiveCategoryWithStrictProductAndCoproductsData", [ IsCapCategory, IsList, IsCapCategory ] );
