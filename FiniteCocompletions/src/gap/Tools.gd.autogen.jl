...
@DeclareFilterDispatchedOperation( "TensorizeObjectWithObjectInRangeCategoryOfHomomorphismStructure" )
...
# =#
@DeclareFilterDispatchedOperation( "TensorizeObjectWithMorphismInRangeCategoryOfHomomorphismStructure" )
...
@DeclareFilterDispatchedOperation( "TensorizeMorphismWithObjectInRangeCategoryOfHomomorphismStructure" )
