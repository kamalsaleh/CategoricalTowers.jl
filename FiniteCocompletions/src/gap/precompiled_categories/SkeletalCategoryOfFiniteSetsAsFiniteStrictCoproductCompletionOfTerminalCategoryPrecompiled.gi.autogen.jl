...
########
function ( cat_1, arg2_1, arg3_1 )
    if (@not AsList( arg2_1 ) == AsList( arg3_1 ))
        return false;
    else
        return true;
    end;
...
########
function ( cat_1, arg2_1, arg3_1 )
    if (@not Cardinality( arg2_1 ) == Cardinality( arg3_1 ))
        return false;
    else
        return true;
    end;
...
function ( cat_1, alpha_1 )
    ...
    hoisted_2_1 = Cardinality( Range( alpha_1 ) );
    return deduped_3_1 == Length( deduped_4_1 ) && ForAll( (1):(deduped_3_1), function ( i_2 )
              local deduped_1_2;
              deduped_1_2 = deduped_4_1[i_2];
              return deduped_1_2 >= 0 && deduped_1_2 < hoisted_2_1;
          end );
end
########
