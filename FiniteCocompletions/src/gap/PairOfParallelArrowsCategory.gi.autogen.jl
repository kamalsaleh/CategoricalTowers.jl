  ...
  function( CAP_NAMED_ARGUMENTS, C )
    ...
    modeling_tower_object_constructor =
      function( ParallelPairs, pair_of_pairs )
        ...
        return ObjectConstructor( PSh_VA, PairGAP( [ V, A ], [ s, t ] ) );
    ...
    modeling_tower_object_datum =
      function( ParallelPairs, obj )
        ...
        return PairGAP( PairGAP( VA[1], VA[2] ), PairGAP( st[1], st[2] ) );
    ...
    modeling_tower_morphism_datum =
      function( ParallelPairs, mor )
        ...
        return PairGAP( mor_datum[1], mor_datum[2] ); ## convert from list to pair for CompilerForCAP
