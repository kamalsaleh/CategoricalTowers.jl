...
@DeclareFilter( "IsFiniteStrictProductCompletion",
        IsCapCategory );

#! @Description
#!  The &GAP; category of cells in a finite product completion category.
@DeclareFilter( "IsCellInFiniteStrictProductCompletion",
        IsCapCategoryCell );

#! @Description
#!  The &GAP; category of objects in a finite product completion category.
@DeclareFilter( "IsObjectInFiniteStrictProductCompletion",
...
@DeclareFilter( "IsMorphismInFiniteStrictProductCompletion",
...
# =#
@DeclareFilterDispatchedOperation( "ExtendFunctorToFiniteStrictProductCompletionData", [ IsFiniteStrictProductCompletion, IsList, IsCapCategory ] );
