...
@DeclareFilter( "IsMorphismInAbelianClosureAsFreydOfCoFreydOfStrictAdditiveClosure",
...
@DeclareFilterDispatchedOperation( "AbelianClosureAsFreydOfCoFreydOfStrictAdditiveClosure" )
...
@DeclareFilterDispatchedOperation( "ExtendFunctorToAbelianClosureData" );
