...
@DeclareFilter( "IsFiniteColimitCompletionWithStrictCoproducts",
        IsCapCategory );

#! @Description
#!  The &GAP; category of cells in the colimit completion of a category.
@DeclareFilter( "IsCellInFiniteColimitCompletionWithStrictCoproducts",
        IsCapCategoryCell );

#! @Description
#!  The &GAP; category of objects in the colimit completion of a category.
@DeclareFilter( "IsObjectInFiniteColimitCompletionWithStrictCoproducts",
...
@DeclareFilter( "IsMorphismInFiniteColimitCompletionWithStrictCoproducts",
