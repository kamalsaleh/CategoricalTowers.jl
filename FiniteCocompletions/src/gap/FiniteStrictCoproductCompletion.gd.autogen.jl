...
@DeclareFilter( "IsFiniteStrictCoproductCompletion",
        IsCapCategory );

#! @Description
#!  The &GAP; category of cells in a finite coproduct cocompletion category.
@DeclareFilter( "IsCellInFiniteStrictCoproductCompletion",
        IsCapCategoryCell );

#! @Description
#!  The &GAP; category of objects in a finite coproduct cocompletion category.
@DeclareFilter( "IsObjectInFiniteStrictCoproductCompletion",
...
@DeclareFilter( "IsMorphismInFiniteStrictCoproductCompletion",
...
@DeclareFilterDispatchedAttribute( "FiniteStrictCoproductCompletion", IsCapCategory );
...
@DeclareFilterDispatchedOperation( "ExtendFunctorToFiniteStrictCoproductCompletionData" )
