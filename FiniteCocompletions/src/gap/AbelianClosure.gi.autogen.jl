...
@InstallMethod( AbelianClosureAsFreydOfCoFreydOfStrictAdditiveClosure,
  ...
  function( C )
    ...
    ##
    category_filter = IsAbelianClosureAsFreydOfCoFreydOfStrictAdditiveClosure && IsWrapperCapCategory;
    category_object_filter = IsObjectInAbelianClosureAsFreydOfCoFreydOfStrictAdditiveClosure && IsWrapperCapCategoryObject;
    category_morphism_filter = IsMorphismInAbelianClosureAsFreydOfCoFreydOfStrictAdditiveClosure && IsWrapperCapCategoryMorphism;
...
@InstallMethod( /,
  ...
  function( name, AC )
    ...
    elseif (IsMorphismInFiniteStrictCoproductCompletion( Yc ))
        ...
        if (CanCompute( AC, "IsMonomorphism" ))
            IsMonomorphism( Yc );
        end;
        
        if (CanCompute( AC, "IsSplitMonomorphism" ))
            IsSplitMonomorphism( Yc );
        end;
        
        if (CanCompute( AC, "IsEpimorphism" ))
            IsEpimorphism( Yc );
        end;
        
        if (CanCompute( AC, "IsSplitEpimorphism" ))
            IsSplitEpimorphism( Yc );
        end;
        
        ## IsIsomorphism == IsSplitMonomorphism and IsSplitEpimorphism
        ## we add this here in case the logic is deactivated
        if (CanCompute( AC, "IsIsomorphism" ))
            IsIsomorphism( Yc );
        end;
...
##
@InstallMethod( ExtendFunctorToAbelianClosureData,
