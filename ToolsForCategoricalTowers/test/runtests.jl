...
using Test, Documenter, Toposes, FinSetsForCAP, MatricesForHomalg, FreydCategoriesForCAP, ToolsForCategoricalTowers

# test upto whitespaces
doctest(ToolsForCategoricalTowers; doctestfilters=[r"\s+" => ""])
