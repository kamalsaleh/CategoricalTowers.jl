...
InstallMethodWithCache( RestrictFunctorToFullSubcategoryOfSource,
  ...
  function( F, full )
    ...
    if (IsIdenticalObj( AsCapCategory( Source( F ) ), AmbientCategory( full ) ))
    ...
    elseif (IsCapFullSubcategory( AmbientCategory( full ) ))
...
InstallMethodWithCache( RestrictFunctorToFullSubcategoryOfRange,
  ...
  function( F, full )
    ...
    if (IsIdenticalObj( AsCapCategory( Target( F ) ), AmbientCategory( full ) ))
