...
@DeclareFilter( "IsBooleanAlgebraOfConstructibleObjectsAsUnionOfMultipleDifferences",
        IsBooleanAlgebraOfConstructibleObjects );

#! @Description
#!  The &GAP; category of objects in ...
#! @Arguments object
@DeclareFilter( "IsConstructibleObjectAsUnionOfMultipleDifferences",
        IsConstructibleObject );

#! @Description
#!  The &GAP; category of morphisms in ...
#! @Arguments morphism
@DeclareFilter( "IsMorphismBetweenConstructibleObjectsAsUnionOfMultipleDifferences",
...
@DeclareOperation( "ListOfObjectsInMeetSemilatticeOfMultipleDifferences",
        [ IsConstructibleObjectAsUnionOfMultipleDifferences ] );
# =#
@DeclareFilterDispatchedOperation( "ListOfObjectsInMeetSemilatticeOfMultipleDifferences" );
...
@DeclareAttribute( "BooleanAlgebraOfConstructibleObjectsAsUnionOfMultipleDifferences",
        IsCapCategory );
# =#
@DeclareFilterDispatchedOperation( "BooleanAlgebraOfConstructibleObjectsAsUnionOfMultipleDifferences" );

#! @Description
#!  If <A>D1</A>=<M>A1-B1</M>, <A>D2</A>=<M>A2-B2</M>, ...,)
