...
@DeclareAttribute( "EquivalenceToMeetSemilatticeOfDifferences",
        IsCapCategory );
# =#
@DeclareFilterDispatchedOperation( "EquivalenceToMeetSemilatticeOfDifferences" );
...
@DeclareOperation( "ListOfSingleDifferences",
        [ IsObjectInMeetSemilatticeOfMultipleDifferences ] );
# =#
@DeclareFilterDispatchedOperation( "ListOfSingleDifferences" );
...
@DeclareAttribute( "MeetSemilatticeOfMultipleDifferences",
        IsCapCategory );
# =#
@DeclareFilterDispatchedOperation( "MeetSemilatticeOfMultipleDifferences" );
