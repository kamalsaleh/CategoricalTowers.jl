...
@DeclareFilter( "IsMeetSemilatticeOfSingleDifferences",
        IsMeetSemilatticeOfDifferences );

#! @Description
#!  The &GAP; category of objects in a meet-semilattice of differences.
#! @Arguments object
@DeclareFilter( "IsObjectInMeetSemilatticeOfSingleDifferences",
        IsObjectInMeetSemilatticeOfDifferences );

#! @Description
#!  The &GAP; category of morphisms in a meet-semilattice of differences.
#! @Arguments morphism
@DeclareFilter( "IsMorphismInMeetSemilatticeOfSingleDifferences",
...
@DeclareFilterDispatchedAttribute( "NormalizedMinuendAndSubtrahendInUnderlyingHeytingOrCoHeytingAlgebroid", IsObjectInMeetSemilatticeOfSingleDifferences );
...
@DeclareOperation( "MinuendAndSubtrahendInUnderlyingLattice",
        [ IsObjectInMeetSemilatticeOfSingleDifferences ] );
# =#
@DeclareFilterDispatchedOperation( "MinuendAndSubtrahendInUnderlyingLattice" );
...
@DeclareOperation( "DistinguishedSubtrahend",
        [ IsObjectInMeetSemilatticeOfSingleDifferences ] );
# =#
@DeclareFilterDispatchedOperation( "DistinguishedSubtrahend" );
...
@DeclareAttribute( "MeetSemilatticeOfSingleDifferences",
        IsCapCategory );
# =#
@DeclareFilterDispatchedOperation( "MeetSemilatticeOfSingleDifferences" );
