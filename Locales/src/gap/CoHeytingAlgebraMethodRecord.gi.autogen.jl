...
@InstallValueConst( COHEYTING_ALGEBRA_METHOD_NAME_RECORD,
        @rec(
...
ConegationOnMorphisms = @rec(
  ...
  output_source_getter_string = "ConegationOnObjects( cat, Target( alpha ) )",
  output_source_getter_preconditions = [ [ "ConegationOnObjects", 1 ] ],
  output_range_getter_string = "ConegationOnObjects( cat, Source( alpha ) )",
  output_range_getter_preconditions = [ [ "ConegationOnObjects", 1 ] ],
...
MorphismFromDoubleConegation = @rec(
  ...
  output_source_getter_preconditions = [ [ "ConegationOnObjects", 2 ] ],
