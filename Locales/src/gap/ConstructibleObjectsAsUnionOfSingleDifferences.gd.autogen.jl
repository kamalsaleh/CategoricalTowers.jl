...
@DeclareFilter( "IsBooleanAlgebraOfConstructibleObjectsAsUnionOfSingleDifferences",
...
#! @Arguments object
@DeclareFilter( "IsConstructibleObjectAsUnionOfSingleDifferences",
...
#!  the latter as unions of formal single differences.
#! @Arguments morphism
@DeclareFilter( "IsMorphismBetweenConstructibleObjectsAsUnionOfDifferences",
...
@DeclareOperation( "ListOfObjectsInMeetSemilatticeOfDifferences",
        [ IsConstructibleObjectAsUnionOfSingleDifferences ] );
# =#
@DeclareFilterDispatchedOperation( "ListOfObjectsInMeetSemilatticeOfDifferences" );
...
@DeclareAttribute( "BooleanAlgebraOfConstructibleObjectsAsUnionOfDifferences",
        IsCapCategory );
# =#
@DeclareFilterDispatchedOperation( "BooleanAlgebraOfConstructibleObjectsAsUnionOfDifferences" );
