...
#= comment for Julia
InstallTrueMethod( IsHeytingAlgebroid, IsBicartesianProset && IsCartesianClosedCategory );
# =#
...
#= comment for Julia
InstallTrueMethod( IsHeytingAlgebra, IsHeytingAlgebroid && IsSkeletalCategory );
# =#
