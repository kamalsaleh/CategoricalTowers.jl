...
function ( cat_1, source_1, alpha_1, beta_1, range_1 )
    ...
    deduped_25_1 = BasisPathsByVertexIndex( deduped_30_1 );
    deduped_24_1 = ObjectList( Range( alpha_1 ) );
    deduped_23_1 = (1):(Length( deduped_27_1 ));
    deduped_22_1 = (1):(Length( deduped_26_1 ));
    hoisted_20_1 = HomStructureOnBasisPaths( deduped_30_1 );
    hoisted_18_1 = List( deduped_32_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, UnderlyingQuiverAlgebraElement );
        end );
    deduped_15_1 = List( deduped_32_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, function ( logic_new_func_x_3 )
                    return VertexIndex( UnderlyingVertex( Target( logic_new_func_x_3 ) ) );
                end );
        end );
    deduped_14_1 = List( deduped_32_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, function ( logic_new_func_x_3 )
    ...
    hoisted_11_1 = List( deduped_32_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, function ( logic_new_func_x_3 )
    ...
    return CreateCapCategoryMorphismWithAttributes( RangeCategoryOfHomomorphismStructure( cat_1 ), source_1, range_1, UnderlyingMatrix, HomalgMatrixListList( UnionOfRowsListList( deduped_29_1, List( (1):(Length( deduped_24_1 )), function ( j_2 )
                                ...
                                return UnionOfRowsListList( deduped_9_3, ListWithKeys( deduped_22_1, function ( key_4, s_4 )
                                          ...
                                          if (deduped_6_4 == 0)
                                              ...
                                              return UnionOfColumnsListList( deduped_6_4, ListWithKeys( deduped_8_1, function ( key_5, t_5 )
                                                        ...
                                                        if (hoisted_1_4[t_5] || deduped_4_5 == 0)
...
########
function ( cat_1, source_1, alpha_1, beta_1, range_1 )
    local hoisted_1_1, deduped_2_1, hoisted_3_1, deduped_4_1, hoisted_5_1, hoisted_6_1, hoisted_7_1, hoisted_8_1, deduped_9_1, deduped_10_1, hoisted_11_1, hoisted_12_1, hoisted_13_1, hoisted_14_1, hoisted_15_1, hoisted_16_1, hoisted_18_1, hoisted_19_1, hoisted_20_1, deduped_22_1, deduped_23_1, deduped_24_1, deduped_25_1, deduped_26_1, deduped_27_1, deduped_28_1, deduped_29_1, deduped_30_1, deduped_31_1, deduped_32_1;
    deduped_32_1 = MorphismMatrix( beta_1 );
    deduped_31_1 = MorphismMatrix( alpha_1 );
    deduped_30_1 = UnderlyingCategory( cat_1 );
    deduped_29_1 = RankOfObject( range_1 );
    ...
    hoisted_20_1 = HomStructureOnBasisPaths( deduped_30_1 );
    hoisted_19_1 = List( deduped_32_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, UnderlyingQuiverAlgebraElement );
        end );
    hoisted_18_1 = List( deduped_31_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, UnderlyingQuiverAlgebraElement );
        end );
    ...
    deduped_9_1 = (1):(Length( deduped_28_1 ));
    hoisted_8_1 = List( deduped_28_1, function ( logic_new_func_x_2 )
            return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    hoisted_7_1 = List( deduped_27_1, function ( logic_new_func_x_2 )
            return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    deduped_2_1 = List( deduped_25_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, Length );
        end );
    deduped_10_1 = List( deduped_23_1, function ( i_2 )
            local hoisted_1_2;
            hoisted_1_2 = deduped_2_1[hoisted_7_1[i_2]];
            return List( deduped_9_1, function ( t_3 )
                    return hoisted_1_2[hoisted_8_1[t_3]];
                end );
        end );
    hoisted_11_1 = List( deduped_23_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2;
            hoisted_1_2 = deduped_10_1[i_2];
            hoisted_2_2 = List( deduped_9_1, function ( t_3 )
                    return hoisted_1_2[t_3];
                end );
            return Sum( List( deduped_9_1, function ( i_3 )
                      return hoisted_2_2[i_3];
                  end ) );
        end );
    hoisted_6_1 = List( deduped_31_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, function ( logic_new_func_x_3 )
                    return IsZero( UnderlyingQuiverAlgebraElement( logic_new_func_x_3 ) );
                end );
        end );
    ...
    hoisted_5_1 = List( deduped_22_1, function ( j_2 )
            local hoisted_1_2;
    ...
    return CreateCapCategoryMorphismWithAttributes( RangeCategoryOfHomomorphismStructure( cat_1 ), source_1, range_1, UnderlyingMatrix, HomalgMatrixListList( UnionOfRowsListList( deduped_29_1, List( deduped_22_1, function ( j_2 )
                  local deduped_1_2, hoisted_2_2, hoisted_3_2;
                  deduped_1_2 = hoisted_5_1[j_2];
                  hoisted_3_2 = Sum( deduped_4_1, function ( s_3 )
                  ...
                  return UnionOfColumnsListList( Sum( List( deduped_4_1, function ( i_3 )
                            ...
                            local deduped_1_3, hoisted_2_3, hoisted_3_3, hoisted_4_3, hoisted_6_3, deduped_7_3, deduped_8_3, deduped_9_3;
                            deduped_9_3 = hoisted_11_1[i_3];
                            if (hoisted_6_1[i_3][j_2])
                                return NullMatImmutable( hoisted_3_2, deduped_9_3 );
                            else
                                deduped_8_3 = hoisted_14_1[i_3][j_2];
                                deduped_7_3 = hoisted_13_1[i_3][j_2];
                                hoisted_6_3 = (1):(deduped_2_1[deduped_7_3][deduped_8_3] );
                                hoisted_4_3 = hoisted_20_1[deduped_8_3];
                                hoisted_3_3 = CoefficientsOfPaths( deduped_25_1[deduped_7_3][deduped_8_3], hoisted_18_1[i_3][j_2] );
                                deduped_1_3 = deduped_10_1[i_3];
                                hoisted_2_3 = Sum( deduped_9_1, function ( t_4 )
                                        return deduped_1_3[t_4];
                                    end );
                                return UnionOfRowsListList( deduped_9_3, List( deduped_4_1, function ( s_4 )
                                          local hoisted_1_4, hoisted_3_4, hoisted_4_4, hoisted_5_4, deduped_6_4;
                                          ...
                                          if (deduped_6_4 == 0)
                                              ...
                                              return UnionOfColumnsListList( deduped_6_4, List( deduped_9_1, function ( t_5 )
                                                        local hoisted_1_5, hoisted_2_5, hoisted_3_5, deduped_4_5, deduped_5_5, deduped_6_5;
                                                        deduped_4_5 = deduped_1_3[t_5];
                                                        if (hoisted_1_4[t_5] || deduped_4_5 == 0)
                                                            return NullMatImmutable( deduped_6_4, deduped_4_5 );
                                                            ...
                                                            hoisted_3_5 = (1):(deduped_2_1[deduped_5_5][deduped_6_5] );
                                                            hoisted_2_5 = hoisted_4_3[deduped_5_5][deduped_7_3][deduped_6_5];
                                                            hoisted_1_5 = CoefficientsOfPaths( deduped_25_1[deduped_5_5][deduped_6_5], hoisted_5_4[t_5] );
                                                            return Sum( hoisted_6_3, function ( p_6 )
                                                                    local hoisted_1_6, hoisted_2_6;
                                                                    hoisted_2_6 = hoisted_2_5[p_6];
                                                                    hoisted_1_6 = hoisted_3_3[p_6];
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    hoisted_3_1 = List( deduped_9_1, function ( logic_new_func_x_2 )
            return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
...
function ( cat_1, source_1, alpha_1, range_1 )
    local hoisted_1_1, hoisted_2_1, hoisted_3_1, hoisted_5_1, hoisted_6_1, deduped_8_1, deduped_9_1, deduped_10_1;
    ...
    return CreateCapCategoryMorphismWithAttributes( RangeCategoryOfHomomorphismStructure( cat_1 ), source_1, range_1, UnderlyingMatrix, HomalgMatrixListList( UnionOfColumnsListList( deduped_9_1, List( (1):(Length( ObjectList( Source( alpha_1 ) ) )), function ( j_2 )
                  local hoisted_1_2, hoisted_2_2, hoisted_3_2;
                  hoisted_3_2 = hoisted_5_1[j_2];
                  hoisted_2_2 = hoisted_3_1[j_2];
                  hoisted_1_2 = hoisted_1_1[j_2];
                  return UnionOfColumnsListList( deduped_9_1, List( hoisted_6_1, function ( s_3 )
...
function ( cat_1, source_1, range_1, alpha_1 )
    local deduped_3_1, hoisted_4_1, deduped_5_1, deduped_6_1, deduped_7_1, hoisted_8_1, hoisted_9_1, hoisted_11_1, deduped_13_1, deduped_14_1, deduped_15_1, deduped_16_1, deduped_17_1;
    deduped_17_1 = UnderlyingCategory( cat_1 );
    deduped_16_1 = ObjectList( range_1 );
    deduped_15_1 = ObjectList( source_1 );
    deduped_14_1 = BasisPathsByVertexIndex( deduped_17_1 );
    deduped_13_1 = (1):(Length( deduped_15_1 ));
    hoisted_11_1 = UnderlyingQuiverAlgebra( deduped_17_1 );
    hoisted_9_1 = CAP_JIT_INCOMPLETE_LOGIC( EntriesOfHomalgMatrixAsListList( UnderlyingMatrix( alpha_1 ) )[1] );
    deduped_6_1 = (1):(Length( deduped_16_1 ));
    deduped_5_1 = List( deduped_16_1, function ( logic_new_func_x_2 )
            return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    hoisted_4_1 = List( deduped_14_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, Length );
        end );
    deduped_3_1 = List( deduped_15_1, function ( logic_new_func_x_2 )
            return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    deduped_7_1 = List( deduped_13_1, function ( j_2 )
            local hoisted_1_2;
            hoisted_1_2 = hoisted_4_1[deduped_3_1[j_2]];
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, source_1, range_1, MorphismMatrix, List( deduped_13_1, function ( j_2 )
              local deduped_1_2, deduped_2_2, hoisted_3_2, hoisted_4_2, deduped_5_2;
              deduped_5_2 = CAP_JIT_INCOMPLETE_LOGIC( j_2 );
              hoisted_4_2 = deduped_15_1[j_2];
              hoisted_3_2 = deduped_14_1[deduped_3_1[j_2]];
              deduped_2_2 = Sum( hoisted_8_1[(1):(deduped_5_2 - 1)] );
              deduped_1_2 = deduped_7_1[deduped_5_2];
              return List( deduped_6_1, function ( s_3 )
                      local deduped_1_3, deduped_2_3;
                      deduped_2_3 = CAP_JIT_INCOMPLETE_LOGIC( s_3 );
                      deduped_1_3 = Sum( deduped_1_2[(1):(deduped_2_3 - 1)] );
                      return CreateCapCategoryMorphismWithAttributes( deduped_17_1, hoisted_4_2, deduped_16_1[s_3], UnderlyingQuiverAlgebraElement, QuiverAlgebraElement( hoisted_11_1, CAP_JIT_INCOMPLETE_LOGIC( hoisted_9_1[(deduped_2_2 + (deduped_1_3 + 1)):(deduped_2_2 + (deduped_1_3 + deduped_1_2[deduped_2_3]))] ), hoisted_3_2[deduped_5_1[s_3]] ) );
                  end );
          end ) );
end
########
...
########
function ( cat_1, source_1, range_1, alpha_1 )
    local deduped_3_1, hoisted_4_1, deduped_5_1, deduped_6_1, deduped_7_1, hoisted_8_1, hoisted_9_1, hoisted_11_1, hoisted_13_1, deduped_15_1, deduped_16_1, deduped_17_1, deduped_18_1, deduped_19_1;
    deduped_19_1 = UnderlyingCategory( cat_1 );
    deduped_18_1 = ObjectList( range_1 );
    deduped_17_1 = ObjectList( source_1 );
    deduped_16_1 = BasisPathsByVertexIndex( deduped_19_1 );
    deduped_15_1 = (1):(Length( deduped_17_1 ));
    hoisted_13_1 = UnderlyingQuiverAlgebra( deduped_19_1 );
    hoisted_9_1 = EntriesOfHomalgMatrixAsListList( UnderlyingMatrix( alpha_1 ) );
    deduped_6_1 = (1):(Length( deduped_18_1 ));
    deduped_5_1 = List( deduped_18_1, function ( logic_new_func_x_2 )
            return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    hoisted_4_1 = List( deduped_16_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, Length );
        end );
    deduped_3_1 = List( deduped_17_1, function ( logic_new_func_x_2 )
            return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    deduped_7_1 = List( deduped_15_1, function ( j_2 )
            local hoisted_1_2;
            hoisted_1_2 = hoisted_4_1[deduped_3_1[j_2]];
            return List( deduped_6_1, function ( s_3 )
                    return hoisted_1_2[deduped_5_1[s_3]];
    ...
    hoisted_8_1 = List( deduped_15_1, function ( j_2 )
            local hoisted_1_2, hoisted_2_2;
            hoisted_1_2 = deduped_7_1[j_2];
            hoisted_2_2 = List( deduped_6_1, function ( s_3 )
    ...
    hoisted_11_1 = List( deduped_15_1, function ( j_2 )
            local deduped_1_2;
            ...
            return List( deduped_6_1, function ( s_3 )
                    ...
                    return List( deduped_15_1, function ( j_4 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, source_1, range_1, MorphismMatrix, List( deduped_15_1, function ( j_2 )
              local hoisted_1_2, hoisted_2_2, hoisted_3_2;
              hoisted_3_2 = deduped_17_1[j_2];
              hoisted_2_2 = deduped_16_1[deduped_3_1[j_2]];
              hoisted_1_2 = hoisted_11_1[j_2];
              return List( deduped_6_1, function ( s_3 )
                      return CreateCapCategoryMorphismWithAttributes( deduped_19_1, hoisted_3_2, deduped_18_1[s_3], UnderlyingQuiverAlgebraElement, QuiverAlgebraElement( hoisted_13_1, hoisted_1_2[s_3][1], hoisted_2_2[deduped_5_1[s_3]] ) );
                  end );
          end ) );
end
########
...
########
function ( cat_1, alpha_1 )
    local hoisted_1_1, hoisted_2_1, hoisted_4_1, hoisted_5_1, hoisted_6_1, hoisted_7_1, hoisted_8_1, hoisted_9_1, hoisted_11_1, hoisted_12_1, deduped_13_1, deduped_14_1, deduped_15_1, deduped_16_1, deduped_17_1, deduped_18_1;
    deduped_18_1 = MorphismMatrix( alpha_1 );
    deduped_17_1 = ObjectList( Range( alpha_1 ) );
    deduped_16_1 = ObjectList( Source( alpha_1 ) );
    deduped_15_1 = Length( deduped_17_1 );
    deduped_14_1 = Length( deduped_16_1 );
    deduped_13_1 = (1):(deduped_14_1);
    hoisted_12_1 = (1):(deduped_15_1);
    hoisted_11_1 = List( deduped_17_1, UnderlyingVertex );
    hoisted_9_1 = List( deduped_18_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, function ( logic_new_func_x_3 )
                    return UnderlyingVertex( Target( logic_new_func_x_3 ) );
                end );
        end );
    hoisted_8_1 = List( deduped_18_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, function ( logic_new_func_x_3 )
    ...
    hoisted_5_1 = UnderlyingQuiverAlgebra( UnderlyingCategory( cat_1 ) );
    ...
    hoisted_2_1 = List( deduped_18_1, Length );
    hoisted_1_1 = List( deduped_18_1, IsList );
    if (!(IsList( deduped_18_1 ) && Length( deduped_18_1 ) == deduped_14_1))
        return false;
    elseif (@not ForAll( deduped_13_1, function ( i_2 )
                 return (hoisted_1_1[i_2] && hoisted_2_1[i_2] == deduped_15_1);
             end ))
        return false;
    elseif (@not ForAll( deduped_13_1, function ( i_2 )
                 local hoisted_1_2, hoisted_2_2, hoisted_3_2, hoisted_4_2, hoisted_5_2, hoisted_6_2;
                 hoisted_6_2 = CAP_JIT_INCOMPLETE_LOGIC( UnderlyingVertex( CAP_JIT_INCOMPLETE_LOGIC( deduped_16_1[i_2] ) ) );
                 ...
                 return ForAll( hoisted_12_1, function ( j_3 )
                         local deduped_3_3, deduped_4_3, deduped_5_3;
                         deduped_5_3 = hoisted_5_2[j_3];
                         deduped_4_3 = hoisted_4_2[j_3];
                         deduped_3_3 = hoisted_3_2[j_3];
                         return (CAP_JIT_EXPR_CASE_WRAPPER( function (  )
                                       if (@not hoisted_1_2[j_3] == hoisted_5_1)
                                           return false;
                                       elseif (hoisted_2_2[j_3])
                                           return true;
                                       elseif (@not ForAll( deduped_3_3, function ( p_5 )
                                                    return deduped_4_3 == Source( p_5 );
                                                end ))
                                           return false;
                                       elseif (@not ForAll( deduped_3_3, function ( p_5 )
                                                    return deduped_5_3 == Target( p_5 );
                                                end ))
                                           return false;
                                       else
                                           return true;
                                       ...
                                       return;
                                   end )(  ) && deduped_4_3 == hoisted_6_2 && deduped_5_3 == hoisted_11_1[j_3]);
                     end );
             end ))
        return false;
    else
...
########
function ( cat_1, alpha_1 )
    local hoisted_1_1, hoisted_2_1, hoisted_4_1, hoisted_5_1, hoisted_6_1, hoisted_7_1, hoisted_8_1, hoisted_9_1, hoisted_10_1, hoisted_11_1, hoisted_12_1, deduped_13_1, deduped_14_1, deduped_15_1, deduped_16_1, deduped_17_1, deduped_18_1;
    deduped_18_1 = MorphismMatrix( alpha_1 );
    deduped_17_1 = ObjectList( Range( alpha_1 ) );
    deduped_16_1 = ObjectList( Source( alpha_1 ) );
    deduped_15_1 = Length( deduped_17_1 );
    ...
    hoisted_12_1 = (1):(deduped_15_1);
    hoisted_11_1 = List( deduped_17_1, UnderlyingVertex );
    hoisted_10_1 = List( deduped_16_1, UnderlyingVertex );
    hoisted_9_1 = List( deduped_18_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, function ( logic_new_func_x_3 )
                    return UnderlyingVertex( Target( logic_new_func_x_3 ) );
                end );
...
function ( cat_1, arg2_1 )
    ...
    deduped_2_1 = ObjectList( arg2_1 );
    hoisted_1_1 = UnderlyingQuiver( UnderlyingCategory( cat_1 ) );
    if (@not IsList( deduped_2_1 ))
        return false;
    elseif (@not ForAll( deduped_2_1, function ( obj_2 )
                 local deduped_1_2;
                 deduped_1_2 = UnderlyingVertex( obj_2 );
                 return (IsQuiverVertex( deduped_1_2 ) && QuiverOfPath( deduped_1_2 ) == hoisted_1_1);
             end ))
        return false;
    else
        return true;
...
function ( cat_1, source_1, list_of_morphisms_1, range_1 )
    local hoisted_3_1, hoisted_5_1, deduped_6_1, deduped_7_1, deduped_8_1;
    deduped_8_1 = UnderlyingCategory( cat_1 );
    deduped_7_1 = ObjectList( range_1 );
    deduped_6_1 = ObjectList( source_1 );
    hoisted_5_1 = (1):(Length( deduped_7_1 ));
    hoisted_3_1 = ZeroImmutable( UnderlyingQuiverAlgebra( deduped_8_1 ) );
    return CreateCapCategoryMorphismWithAttributes( cat_1, source_1, range_1, MorphismMatrix, List( (1):(Length( deduped_6_1 )), function ( i_2 )
              local hoisted_1_2;
              hoisted_1_2 = deduped_6_1[i_2];
              return List( hoisted_5_1, function ( j_3 )
                      return CreateCapCategoryMorphismWithAttributes( deduped_8_1, hoisted_1_2, deduped_7_1[j_3], UnderlyingQuiverAlgebraElement, Iterated( List( list_of_morphisms_1, function ( m_4 )
                                  return CAP_JIT_INCOMPLETE_LOGIC( UnderlyingQuiverAlgebraElement( CAP_JIT_INCOMPLETE_LOGIC( CAP_JIT_INCOMPLETE_LOGIC( MorphismMatrix( m_4 )[i_2] )[j_3] ) ) );
                              end ), function ( alpha_4, beta_4 )
                                return alpha_4 + beta_4;
                            end, hoisted_3_1 ) );
                  end );
