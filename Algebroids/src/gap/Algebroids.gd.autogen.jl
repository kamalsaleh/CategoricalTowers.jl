...
@DeclareFilter( "IsCellInAlgebroid",
        IsCapCategoryCell );

#! @Description
#!  The &GAP; category of objects in an algebroid.
@DeclareFilter( "IsObjectInAlgebroid",
        IsCellInAlgebroid && IsCapCategoryObject );

#! @Description
#!  The &GAP; category of morphisms in an algebroid.
@DeclareFilter( "IsMorphismInAlgebroid",
        IsCellInAlgebroid && IsCapCategoryMorphism );

#! @Description
#!  The &GAP; category of algebroids.
@DeclareFilter( "IsAlgebroid",
        IsCapCategory );

#! @Description
#!  The &GAP; category of algebras.
@DeclareFilter( "IsAlgebraAsCategory",
        IsAlgebroid );

#! @Description
#!  The &GAP; category of morphisms of algebroids.
@DeclareFilter( "IsAlgebroidMorphism",
        IsCapFunctor );
