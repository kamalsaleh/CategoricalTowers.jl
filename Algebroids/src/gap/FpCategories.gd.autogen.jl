...
@DeclareFilter( "IsFpCategory",
        IsCapCategory );

#! @Description
#!  The &GAP; category of algebras.
@DeclareFilter( "IsMonoidAsCategory",
        IsFpCategory );

#! @Description
#!  The &GAP; category of cells in a finitely presented category.
@DeclareFilter( "IsCellInFpCategory",
        IsCapCategoryCell );

#! @Description
#!  The &GAP; category of objects in a finitely presented category.
@DeclareFilter( "IsObjectInFpCategory",
        IsCellInFpCategory && IsCapCategoryObject );

#! @Description
#!  The &GAP; category of morphisms in a finitely presented category.
@DeclareFilter( "IsMorphismInFpCategory",
        IsCellInFpCategory && IsCapCategoryMorphism );
