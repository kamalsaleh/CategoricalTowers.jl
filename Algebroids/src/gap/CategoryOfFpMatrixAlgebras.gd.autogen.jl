...
#! @Arguments category
@DeclareFilter( "IsCategoryOfFpMatrixAlgebras", IsCapCategory );

#! @Description
#!  The &GAP; category of finitely presented associative unital matrix algebras.
#! @Arguments object
@DeclareFilter( "IsObjectInCategoryOfFpMatrixAlgebras", IsCapCategoryObject );

#! @Description
#!  The &GAP; category of morphisms of finitely presented associative unital matrix algebras.
#! @Arguments morphism
@DeclareFilter( "IsMorphismInCategoryOfFpMatrixAlgebras", IsCapCategoryMorphism );
