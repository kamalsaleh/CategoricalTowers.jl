...
#! @Arguments category
@DeclareFilter( "IsCategoryOfFpAlgebras", IsCapCategory );

#! @Description
#!  The &GAP; category of finitely presented associative unital algebras.
#! @Arguments object
@DeclareFilter( "IsObjectInCategoryOfFpAlgebras", IsCapCategoryObject );

#! @Description
#!  The &GAP; category of morphisms of finitely presented associative unital algebras.
#! @Arguments morphism
@DeclareFilter( "IsMorphismInCategoryOfFpAlgebras", IsCapCategoryMorphism );
...
#! @Arguments lin_cat
@DeclareAttribute( "CategoryOfFpAlgebras", IsCapCategory && IsLinearCategoryOverCommutativeRing );
...
#!  The output is the category of finitely presented associative unital algebras over $k$.
#! @Arguments k
@DeclareAttribute( "CategoryOfFpAlgebras", IsHomalgRing && IsCommutative );
